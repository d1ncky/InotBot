        ...
        try {
            ...
            const log = {
                embeds: [{
                    ...
                    description: interaction.user.toString() + " изменил ваш баланс! Теперь он **" + newbalance + " RUB**"
                }]
            }
            await u.send(log);
        } catch {}
            ...
            embeds: [
                {
                    ...
                    description: "Пользователю <@!" + userid + "> баланс был **успешно** поменян на **"+ newbalance +" RUB**"
                }
            ],
            components: [
                {
