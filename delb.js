        ...
        try {
            ...
            const log = {
                embeds: [{
                    ...
                    description: interaction.user.toString() + " забрал у вас **"+ newbalance +" RUB**! Теперь у вас **" + accounts[acc_i].balance + " RUB**"
                }]
            }
            await u.send(log);
        } catch {}
            ...
            embeds: [
                {
                    ...
                    description: "Пользователь <@!" + userid + "> потерял **часть баланса** в размере **"+ newbalance +" RUB**"
                }
            ],
            components: [
                {
